...
%Running title
\fancyhead[R]{\small{POPULATION CODING FOR REWARDED CHOICES}} 
...
% Introduction
\input{Sections/Chapter2_Intro}

% Results
\input{Sections/Chapter2_Results}

% Discussion
\input{Sections/Chapter2_Discussion}

% Materials & Methods
\input{Sections/Chapter2_MatMeth}

% Acknowledgements
\input{Sections/Chapter2_Acknowledgments.tex}